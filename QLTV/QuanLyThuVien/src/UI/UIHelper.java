...
public class UIHelper {
	...
	public static void addButtonsAndSearch(JPanel p, GridBagConstraints gbc, JTextField txtTim) {
		...
		pBtn.add(new JButton("Thêm"));
		pBtn.add(new JButton("Cập Nhật"));
		pBtn.add(new JButton("Xóa"));
		pBtn.add(new JButton("Làm Mới"));
		p.add(pBtn, gbcBtn);
		...
		pSearch.add(new JButton("Tìm"), BorderLayout.EAST);
